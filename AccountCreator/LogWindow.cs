...
namespace AccountCreator
{
    public class LogWindow
    {
        ...
        {
            private const string DEFAULT_MESSAGE_FORMAT = "{8}";
            ...
            private void DrawItemHandler(object sender, DrawItemEventArgs e)
            {
                if (e.Index >= 0)
                {
                    ...
                    e.Graphics.DrawString(FormatALogEventMessage(logEvent, _messageFormat),
                        new Font("Lucida Console", 8.25f, FontStyle.Regular), new SolidBrush(color), e.Bounds);
                }
            }
            ...
            public ListBoxLog(ListBox listBox, string messageFormat) : this(listBox, messageFormat,
                DEFAULT_MAX_LINES_IN_LISTBOX)
            {
            }
